...
public class AccountService {
	...
	public String createSavingAccount(Long userId, String accountTypeUniqueNo, Long depositBalance,
		...
		CreateSavingDto dto = sendPostAboutCreateSavingAccount(userKey, accountTypeUniqueNo, depositBalance,
			withdrawalAccountNo);
	...
	private CreateSavingDto sendPostAboutCreateSavingAccount(String userKey, String accountTypeUniqueNo,
		Long depositBalance, String withdrawalAccountNo) {
		try (CloseableHttpClient client = HttpClients.createDefault()) {
	...
	private CreateDepositDto sendPostAboutCreateDepositAccount(String userKey, String accountNo, Long amount,
